<template>
    <div class="bookmarks-container">
      <div class="bookmarks-wrapper">
        ...
        <!-- Empty state ketika tidak ada bookmark -->
    ...
    methods: {
      async loadBookmarkedDevotionals() {
        try {
          ...
          const bookmarkIds = JSON.parse(localStorage.getItem('bookmarkedDevotionals')) || []
          ...
          console.log('🔍 [BookmarksPage] Loading bookmarks:', bookmarkIds)
          ...
          for (const id of bookmarkIds) {
            try {
              ...
              console.warn('⚠️ [BookmarksPage] Failed to load devotional:', id, error)
          ...
          console.log('✅ [BookmarksPage] Loaded', devotionals.length, 'bookmarks')
      ...
      goToDetail(devotionalId) {
        if (this.isSwipeActive) return // Jangan navigate kalau sedang swipe
      ...
      onTouchMove(event) {
        ...
        // Hanya izinkan swipe ke kiri (positive diffX)
        if (diffX > 0) {
          this.swipeOffset = -Math.min(diffX, 100) // Maksimal 100px
      ...
      onTouchEnd() {
        ...
        // Jika swipe lebih dari 50px, show delete button
      ...
      closeDeleteModal() {
        ...
        this.swipeOffset = 0 // Reset swipe
      },
      ...
      async deleteBookmark() {
        ...
        console.log('✅ [BookmarksPage] Bookmark deleted:', devotionalId)
