<template>
    <div class="account-container">
      <div class="account-wrapper">
        ...
        <div class="menu-section">
          ...
          <div class="menu-item" @click="goToFirebaseTest">
  ...
  export default {
    ...
    computed: {
      ...
      userSektor() {
        return this.userStore.sektorUser ? `Sektor ${this.userStore.sektorUser}` : 'Sektor tidak diketahui'
      },
    ...
    methods: {
      ...
      cancelLogout() {
        console.log('🚫 [AccountPage] Logout cancelled')
      ...
      async confirmLogout() {
        try {
          ...
          console.log('🔍 [AccountPage] === LOGOUT PROCESS START ===')
          console.log('🔍 [AccountPage] User before logout:', this.userName)
          
          // ⭐ STEP 1: Call userStore logout (akan clear semua data)
          this.userStore.logout()
          
          // ⭐ STEP 2: Close modal
          this.showLogoutConfirm = false
          
          // ⭐ STEP 3: Navigate to login dengan replace (tidak bisa back)
          await this.$router.replace('/')
          
          console.log('✅ [AccountPage] === LOGOUT PROCESS COMPLETE ===')
          console.log('✅ [AccountPage] User logged out successfully, redirected to login')
          
        } catch (error) {
          console.error('❌ [AccountPage] Logout error:', error)
          
          // Tetap redirect meskipun ada error
          this.userStore.logout() // Force logout
          await this.$router.replace('/')
