...
export default {
  ...
  methods: {
    goToManageNews() {
      // Nanti akan dibuat halaman manage news
      this.$router.push('/pengurus/news')
    },

    goToManageSchedule() {
      // Nanti akan dibuat halaman manage schedule
      this.$router.push('/pengurus/jadwal')
    },

    goToManageDevotionals() {
      // Nanti akan dibuat halaman manage devotionals
      this.$router.push('/pengurus/renungan')
    },

    goToManageAnnouncements() {
      // Nanti akan dibuat halaman manage announcements
      this.$router.push('/pengurus/pengumuman')
    },

    goToMembersList() {
      // Nanti akan dibuat halaman members list
      this.$router.push('/pengurus/jemaat')
    },
